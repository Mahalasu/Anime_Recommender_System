...
def train_item2vec(
    anime_seq: DataFrame, rating_df: DataFrame
    ...
    def build_user_emb(anime_seq):
        anime_embs = [item_emb[a_id] if a_id in item_emb else [] for a_id in anime_seq]
